...
![modern object detection architecture](deeplearn/imgs/high_level_yolo_v4.png){width=80% fig-align="center"}
...
![yolo v4 architecture](deeplearn/imgs/yolov4_arc.png){width=80% fig-align="center"}
...
![yolox architecture](deeplearn/imgs/yolox_arc.png){width=80% fig-align="center"}
...
<span style="color:Crimson"> MS COCO AP: 55.9% AP(50): 73.5% - input 1280 pixels </style>
